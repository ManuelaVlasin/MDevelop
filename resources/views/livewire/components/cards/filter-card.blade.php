<div>
    <div class="card" style="width: 227px;">
        ...
        <div class="card-body" style="display: {{ $open ? '' : 'none' }}; max-height: 171px; overflow-y: scroll; font-size: 13px">
            @forelse($options as $id => $name)
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" wire:click="selectOption({{$id}})">
