...
<body>
{{--<nav style="background-color: #fff8cc !important;" class="navbar navbar-expand-lg navbar-light bg-light">--}}
{{--    <a class="navbar-brand" href="#">MDevelop</a>--}}
...
<div>
    <div class="row">
        <div class="col brand-logo mt-5">
            <h1 style="font-size: 110px">MDevelop</h1>
        </div>
        <div class="col mt-5">
            <nav class="navbar navbar-expand-lg d-block nav-design">
                <div>
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item active">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="/lessons">Action</a>
                                <a class="dropdown-item" href="#">Another action</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="#">Something else here</a>
                            </div>
                ...
                <div class="slogan">
                    <h2 style="margin-top: 50px">
                        <i>Oferă-ți libertatea de a lucra din orice colț al lumii</i>
                        {{--                        <img src="https://library.kissclipart.com/20181218/plw/kissclipart-island-transparent-clipart-palm-islands-clip-art-e6036b5da582703e.png">--}}
                    </h2>
                </div>
            </nav>
...
<div>
    <svg baseprofile="tiny" stroke-linecap="round" stroke-linejoin="round" version="1.2" viewbox="0 0 2000 857"
        ...
        <a xlink:title="Australia" xlink:href="https://www.google.com/search?q=Australia" target="_blank">
        ...
        <a xlink:title="United States" xlink:href="https://www.google.com/search?q=United%20States" target="_blank">
        ...
        <g stroke="black" stroke-width="30" fill="red">
...
<div>
    <img src="https://media0.giphy.com/media/8tl8tNM8W7wdyEsbbV/giphy.gif?cid=ecf05e470vzehphvvlunyfwtfc7xpynd4aw711t3p7kxun2u&rid=giphy.gif&ct=g" />
</div>
...
<style>
    ...
    * {
    ...
    body {
        background-image: linear-gradient(#caf0f8, #dc9d00);
    }
